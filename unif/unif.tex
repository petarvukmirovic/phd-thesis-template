...
in various areas of computer science and matemathics are based on variants of
...
Building on the JP procedure, we designed a new procedure (Section\ref{sec:unif:the-unification-procedure}) with the same completeness guarantees (Sect.~\ref{sec:unif:proof-of-completeness}).
...
the Zipperposition prover (Sect.~\ref{sec:unif:implementation}). Since a
...
The following rules, however, are stated modulo orientation. This means that 
...
\begin{proof}
  ...
  \begin{description}
    ...
    \begin{itemize}
      ...
      left-hand side.
    \end{itemize}
    \item[Projection] Similar to the previous transition rule, we have two cases:
      \begin{itemize}
