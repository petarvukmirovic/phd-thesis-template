...
this incomplete extension of \lsup{} to full higher-order logic, Bentkamp
...
definition of this polymorphic logic.
...
\cite{sb-21-leo3} recognizes definitions of all symbols that correspond to choice and deals with
...
As a pragmatic extension of the lambda-superposition calculus, Bentkamp et al. \cite{bbtvw-21-sup-lam} propose to alter core generating inference rules of \lsup{}
...
\begin{sloppypar}
  ...
  be dealt with more efficiently using the core
  rules of the superposition calculus. To simplify the resulting clauses of \infname{Abs} rules,
  we also eagerly remove literals $s_i \not\eq s'_i$ by applying the first
...
For \infname{BoolEF} family of rules, we convert disequations into equations
...
\looseness=-1
In both pure and cooperative mode, Satallax is the winner. Zipperposition comes
