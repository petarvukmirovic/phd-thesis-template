...
Our approach is implemented in Zipperposition
...
$n>0$. By \infname{Abs} we denote the union of
...
text with \infname{Abs} we assume the version that supports Boolean extensionality.
...
equal. Without the \infname{Abs} rules Zipperposition relies on
...
the \infname{Bool} family of rules helps solve the problems that get obfuscated by clausification.
