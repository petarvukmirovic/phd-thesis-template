...
\begin{enumerate}
    ...
    $\lambda$-abstraction and first-class Booleans \cite{bbcw-21-lfho}. We call
    this calculus \lfsup{}.
    \item Alexander Bentkamp, Blanchette, Tourret,  Vukmirović, and Waldmann
    extended this calculus to support $\lambda$-abstraction
    \cite{bbtvw-21-sup-lam}. We call it \lsup{}.
    ...
    designing the complete calculus for full higher-order logic. We call this
    calculus \osup{}.
\end{enumerate}
