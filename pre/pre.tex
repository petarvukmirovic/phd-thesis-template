...
\emph{Terms} are the basic building blocks of first-order logic. Variables
...
$\left(\varrho\sigma\right)t=\varrho\left(\sigma t\right)$. We say that substitution is {\em grounding}
...
discussed logic, there exists such a transformation that does not affect
...
unifiers to higher-order logic, the concept of {\em complete sets of unifiers} was
introduced.
...
\in E$. A complete set of unifiers (\emph{CSU}) of $E$ is defined as a
