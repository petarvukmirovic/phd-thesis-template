...
on their normal forms, {\em clauses}. Thus, the initial problem, expressed as a
...
using transformation similar to the one used in the first-order case. We have analyzed
different approaches to clausification in higher-order context \cite{bbtv-21-full-ho-sup}.
...
\infname{ER} rule is used to replace equals by equals within a clause.
