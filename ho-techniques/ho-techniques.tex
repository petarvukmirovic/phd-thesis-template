...
Nummelin worked on implementation of FOOL preprocessing. Simon Cruanes is the
...
higher-order logic really improves the state of the art for the first time. We
...
The results are given in Fig.~\ref{fig:rewrite}. In all the figures in this chapter, each
...
which are different than $\itrue$ or $\ifalse$ and not occurring at either side
...
Zipperposition. We give detailed a description of $\lambda$E, as well as reasoning
