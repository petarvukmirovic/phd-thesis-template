...
with the exception of inference streams that were designed by Alexander
...
\begin{abstract}
    ...
    Zipperposition won the THF division of the CASC competition in 2020 and 2021.  
  \end{abstract}
\newpage
...
Many higher-order problems use symbol definitions extensively to decrease the
...
\NumberOK{two}-problem difference may just be noise. Even though it proves fewer
...
Higher-order logic identifies formulas with terms of Boolean type. To prove a conjecture, we often
