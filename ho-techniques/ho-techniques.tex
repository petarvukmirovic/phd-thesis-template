...
performance much. A similar idea has been discussed in the context of \infname{Cases}(\infname{Simp}) rule
...
Each stream is associated with a weight, and $\mathcal{Q}$ is sorted in order of
...
Entry point to the above pseudocode is the function \textsc{GivenClause}, called
...
\looseness=-1
For evaluation of our unification algorithm (using somewhat different
evaluation setup and older version of Zipperposition), we also compared a complete, nonterminating variant of the
...
improves the performance. To reduce the effort required for integrating multiple backends, we chose Ehoh, an extension of E \cite{scv-19-e23} to support \lfsup{},  as our single
...
all higher-order provers that competed at CASC in 2020:\ CVC4 1.9
...
Zipperposition. We give detailed description of $\lambda$E, as well as reasoning
behind all design decision we took in Chapter \ref{ch:ehoh2}.
