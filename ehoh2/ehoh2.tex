...
\[\begin{array}{@{}l@{\kern1em}l@{\kern1em}l@{\kern1em}l@{\kern1em}l@{}}
  ...
  \emph{prefix optimization} (Sect.~\ref{sec:ehoh:introduction}): A method which, given a demodulator $s \eq t$, allows
  ...
  benchmarks coming from interactive theorem proving practice, which has been our goal since 2016. \ehohii{}'s
