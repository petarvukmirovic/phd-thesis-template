...
to describe a theory formally and to prove the statements about this theory
using rules of the inference system the proof assistant is based on. These
...
They proved indispensible in proving very complex mathematical theorems in a
...
and Isabelle \cite{lc-88-isabelle} using \emph{hammers} CoqHammer \cite{ck-18-coqhammer}, HOL(y)Hammer \cite{ku-15-holyhammer}
and Sledgehammer \cite{bn-10-sh}, respectively. 
