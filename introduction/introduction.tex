...
since it provided better guided search space exploration.
...
and Isabelle \cite{lc-88-isabelle} using the \emph{hammers} CoqHammer
...
We identified three stops on the road to full higher-order logic. A
...
\begin{itemize}
  ...
  We had to modify internal term representation of E to support $\lambda$-free
  ...
  \item After spending so much time and energy on developing higher-order
