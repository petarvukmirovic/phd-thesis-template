...
\ref{it:size} from the above wishlist  is fulfilled for free, as E is very
...
efficiency on first-order problems was not affect. In other words, while trying
...
stated in the problem. For example, suppose we want to prove that there is a
...
can naturally represent statements such as ``whatever Jasmin says is true'' as
